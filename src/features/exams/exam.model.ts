...
const answerSchema = new Schema({ questionNumber: { type: Number, required: true, min: 1 }, correctAnswer: { type: String, required: true } }, { _id: false });
...
export const ExamModel: Model<Exam> = models.Exam ?? model<Exam>("Exam", examSchema);
