    ...
    <section className="w-full rounded-xl border border-slate-200 bg-white p-6 shadow-[0_12px_32px_-12px_rgba(23,38,51,.18)]">
      ...
      <div className="mt-6 grid grid-cols-2 rounded-lg bg-[#e8f5f5] p-1">
        <button
          ...
          className={`rounded-lg px-3 py-2 text-base ${tab === "login" ? "bg-white font-medium shadow-sm" : "text-slate-600"}`}
        >
          Entrar
        </button>
        <button
          ...
          className={`rounded-lg px-3 py-2 text-base ${tab === "signup" ? "bg-white font-medium shadow-sm" : "text-slate-600"}`}
        >
          Cadastrar
        </button>
      </div>
      {tab === "login" ? (
        <form action={signIn} className="mt-6 space-y-5">
          ...
          <button className="h-11 w-full rounded-xl bg-[#007782] font-semibold text-white shadow-sm hover:bg-[#006571]">
            Entrar
          </button>
          <button
            type="button"
        ...
        <form action={signUp} className="mt-7 space-y-5">
          <label className="block text-base font-medium">
            ...
            <input
              name="name"
              required
              className="mt-1.5 h-12 w-full rounded-xl border border-slate-300 px-3"
            />
          </label>
          <label className="block text-base font-medium">
            E-mail
          ...
          <button className="h-12 w-full rounded-xl bg-[#007782] font-semibold text-white">
            Cadastrar
          </button>
        </form>
      )}
